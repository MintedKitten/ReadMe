...
const getOneProfile = () => {
  ...
  return testProfile.find(profile => profile.acc_id === token);
};

const TryEditProfile = value => {
...
const getOneBookInformation = id => {
  return getBookInformation().find(book => book.id === id);
};
