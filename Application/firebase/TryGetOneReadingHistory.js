...
import TryGetReadingHistory from './TryGetReadingHistory';
...
const TryGetOneReadingHistory = id => {
  return TryGetReadingHistory().find(hist => hist.id === id);
};

export default TryGetOneReadingHistory;
